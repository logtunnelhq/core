...
/// <summary>
/// Bound configuration for the on-disk Layered configuration file written
...
public sealed class LayeredConfigOptions
{
    ...
    public const string SectionName = "Layered:Config";

    /// <summary>
    /// Directory to which <c>.layered.json</c> is written. Defaults to the
