...
// with LogTunnel.Api so the same LLM__PROVIDER / LLM__APIKEY work in both
...
// that `logtunnel configure` can run without an API key configured.
...
hostBuilder.Logging.AddFilter("LogTunnel.Core", LogLevel.None);

hostBuilder.Services.AddSingleton<LogTunnelProjectConfigStore>();
...
var rootCommand = new RootCommand(
    "LogTunnel — translate raw Git commits into audience-specific changelogs.");
