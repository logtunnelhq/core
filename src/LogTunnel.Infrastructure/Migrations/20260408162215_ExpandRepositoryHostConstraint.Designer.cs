...
namespace LogTunnel.Infrastructure.Migrations
{
    ...
    [Migration("20260408162215_ExpandRepositoryHostConstraint")]
    partial class ExpandRepositoryHostConstraint
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("translations", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_translations_status", "status IN ('pending','ready','failed')");
                        });
                });
